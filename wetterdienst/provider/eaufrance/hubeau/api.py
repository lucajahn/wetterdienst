...
class HubeauValues(ScalarValuesCore):
    ...
    def _collect_station_parameter(self, station_id: str, parameter: Enum, dataset: Enum) -> pd.DataFrame:
        ...
        try:
            ...
            df = pd.DataFrame(columns=[Columns.STATION_ID.value,Columns.DATE.value,Columns.VALUE.value,Columns.QUALITY.value,])
        ...
        ).loc[:, [Columns.STATION_ID.value, Columns.DATE.value, Columns.VALUE.value,Columns.QUALITY.value,]]
